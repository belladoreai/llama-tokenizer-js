...
- Easy to use: 0 dependencies, code and data baked into a [single file](packages/llama-tokenizer/src/index.js).
...
See [tests](packages/llama-tokenizer/src/test.js) for example test.
